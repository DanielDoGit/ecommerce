		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-5 mb-lg-0">
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu " aria-labelledby="navbarDropdown">
							...
							<li class="dropdown-submenu"><a
								class="dropdown-item dropdown-toggle" href="#">Cliente</a>
							...
							<li class="dropdown-submenu"><a
								class="dropdown-item dropdown-toggle" href="#">Fornecedor</a>
								<ul class="dropdown-menu">
									<li><a class="dropdown-item" href="#">Cadastrar</a></li>
									<li><a class="dropdown-item" href="#">Pesquisar</a></li>
							...
							<li class="dropdown-submenu"><a
								class="dropdown-item dropdown-toggle" href="#">Funcionario</a>
								<ul class="dropdown-menu">
									<li><a class="dropdown-item" href="#">Cadastrar</a></li>
									<li><a class="dropdown-item" href="#">Pesquisar</a></li>
							...
							<li class="dropdown-submenu"><a
								class="dropdown-item dropdown-toggle" href="#">Cidade</a>
								<ul class="dropdown-menu">
									<li><a class="dropdown-item" href="#">Cadastrar</a></li>
									<li><a class="dropdown-item" href="#">Pesquisar</a></li>
							...
							<li class="dropdown-submenu"><a
								class="dropdown-item dropdown-toggle" href="#">Produto</a>
								<ul class="dropdown-menu">
									<li><a class="dropdown-item" href="#">Cadastrar</a></li>
									<li><a class="dropdown-item" href="#">Pesquisar</a></li>
							...
							<li class="dropdown-submenu"><a
								class="dropdown-item dropdown-toggle" href="#">Grupo</a>
								<ul class="dropdown-menu">
									<li><a class="dropdown-item" href="#">Cadastrar</a></li>
									<li><a class="dropdown-item" href="#">Pesquisar</a></li>
					...
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" id="navbarDropdown" role="button"
						data-bs-toggle="dropdown" aria-expanded="false"> Processos </a>
						<ul class="dropdown-menu " aria-labelledby="navbarDropdown">

							<li class="dropdown-submenu"><a
								class="dropdown-item dropdown-toggle" href="#">Venda</a>
								<ul class="dropdown-menu">
									<li><a class="dropdown-item" href="#">Cadastrar</a></li>
							...
							<li class="dropdown-submenu"><a
								class="dropdown-item dropdown-toggle" href="#">Compra</a>
								<ul class="dropdown-menu">
									<li><a class="dropdown-item" href="#">Cadastrar</a></li>
									<li><a class="dropdown-item" href="#">Excluir</a></li>
							...
							<li class="dropdown-submenu"><a
								class="dropdown-item dropdown-toggle" href="#">Ajuste de
									Estoque</a>
								<ul class="dropdown-menu">
									<li><a class="dropdown-item" href="#">Cadastrar</a></li>
