...
COPY public.ajusteestoque (codigo, motivo, dataajuste, quantidade, tipo, produto) FROM stdin;
\.
...
COPY public.estoque (codigo, descricao, quantidade, tipo, produto, origemevento) FROM stdin;
\.
...
1	daniel	45278457805	Teste	Rua teste	1	1	true 	1
3	Fernando Cesar de Lima	57823304066	teste	Teste	2	2	true 	2
\.
...
COPY public.produto (codigo, descricao, margem, precocusto, precovenda, fornecedor, grupo) FROM stdin;
\.
...
COPY public.recebimento (codigo, valor, dataemissao, datavencimento, quitada, venda, condicaopagamento, formapagamento) FROM stdin;
\.
...
COPY public.venda (codigo, datacriacao, totalvenda, cliente) FROM stdin;
\.
